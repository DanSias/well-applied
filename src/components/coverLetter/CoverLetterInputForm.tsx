  ...
  return (
    <div>
      <textarea
        ...
        className="w-full p-4 border rounded-md min-h-[40rem] max-h-[70vh] overflow-auto"
        placeholder="Paste your existing cover letter here..."
      />
      <button
        onClick={handleClearCoverLetter}
        className="hidden mt-4 w-full bg-red-600 text-white py-2 rounded-lg hover:bg-red-700 transition">
        Clear Cover Letter
      </button>
    </div>
  );
